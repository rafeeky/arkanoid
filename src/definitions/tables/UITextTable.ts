...
export const UITextTable: UITextEntry[] = [
  ...
  { textId: 'txt_item_expand_name',  value: 'EXPAND' },
  { textId: 'txt_item_expand_desc',  value: 'BAR LENGTH x1.5' },
  { textId: 'txt_intro_page_01',     value: 'LONG AGO, THE BRICKS FELL FROM THE SKY.' },
  { textId: 'txt_intro_page_02',     value: 'ONLY THE BAR AND THE BALL REMAIN.' },
  { textId: 'txt_intro_page_03',     value: 'RECLAIM THE STAGES.' },
