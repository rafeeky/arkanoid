...
describe('GameplayLifecycleHandler.resetForRetry', () => {
  ...
  it('resetForRetry: spinnerStates 는 그대로 유지', () => {
    const handler = makeHandler();
    const spinners = [
      { id: 'spinner_0', definitionId: 'spinner_cube', x: 100, y: 200, angleRad: 0.5, phase: 'circling' as const, spawnElapsedMs: 400, descentEndY: 200, circleCenterX: 100, circleCenterY: 350, circleRadius: 150, circleAngleRad: -Math.PI / 2, spawnX: 100 },
    ] as const;
